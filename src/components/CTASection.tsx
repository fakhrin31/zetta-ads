...
const CTASection = () => {
  ...
  const startLink = createWhatsAppLink("Halo Zettatech, saya siap untuk memulai digitalisasi bisnis saya!");
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href={startLink} target="_blank" rel="noopener noreferrer"> {/* <-- 3. Bungkus Button */}
